    ...
    public partial class Create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Applicants",
                columns: new[] { "ApplicantId", "ApplicantName", "AppliedFor", "BirthDate", "Gender", "IsReadyToWork" },
                values: new object[] { 1, "A Applicant", "Peon", new DateTime(2005, 1, 2, 0, 59, 35, 441, DateTimeKind.Local).AddTicks(3854), 2, false });
